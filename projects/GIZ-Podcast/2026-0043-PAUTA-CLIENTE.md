# 2026-0043 Propuesta de Pauta – Cliente
...
El activo central es un spot promocional único que se adapta a formatos video y audio. Durante cada ola se complementa con una mezcla de clips extraídos de los podcasts de video para entregar versiones más cortas o distintos ángulos creativos, manteniendo coherencia narrativa con el spot base. Esto permite:

- **Reutilizar un solo asset** con cortes para YouTube (15‑30 s) y Spotify (audio nativo).  
- **Refrescar el mensaje** con variantes específicas por ola (nuevo hook, énfasis en temas relevantes).  
- **Maximizar eficiencia** de inversión porque el mismo production set sirve para todas las ejecuciones y soportes.

## Plan por olas y canales
...
| Área | Qué cubre |
|:--|:--|
| Planificación y estrategia | Definición de metas, mix de medios y calendarización por ola |
| Segmentación y configuración | Audiencias por ciudad, estructuras CBO/ABO y parámetros de optimización |
...
- Alcance mensual y total por ciudad  
- Reproducciones completas (Video Views y Spotify plays)  
- Frecuencia controlada para evitar saturación  
- CPR/CPV medio con comparativa semanal al benchmark  
- Tasa de escucha >50% por ola  
- Crecimiento mensual de nuevos oyentes frente al baseline inicial
